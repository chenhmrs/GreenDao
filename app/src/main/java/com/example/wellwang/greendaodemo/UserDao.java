...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property WifeId = new Property(5, long.class, "wifeId", false, "WIFE_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"WIFE_ID\" INTEGER NOT NULL );"); // 5: wifeId
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        stmt.bindLong(6, entity.getWifeId());
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getLong(offset + 5) // wifeId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setWifeId(cursor.getLong(offset + 5));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN WIFE T0 ON T.\"WIFE_ID\"=T0.\"_id\"");
            builder.append(' ');
